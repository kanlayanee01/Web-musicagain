...
<div class="Tap">
    ...
    <div class="center"><h1>ศิลปินทั้งหมด</h1></div>
    <div class="right">
        <div class="dropdown">
    ...
    <div class="centermain">
        <div class="gridcard">
            <?php foreach ($artists as $artist): ?>
                <div class="card">
                    <img class="ImgSong" src="uploads/images/<?php echo htmlspecialchars($artist['image']); ?>" alt="artist">
